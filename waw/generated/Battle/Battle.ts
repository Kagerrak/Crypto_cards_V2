...
export class StatusEffectsResolved extends ethereum.Event {
  get params(): StatusEffectsResolved__Params {
    return new StatusEffectsResolved__Params(this);
  }
}

export class StatusEffectsResolved__Params {
  _event: StatusEffectsResolved;

  constructor(event: StatusEffectsResolved) {
    this._event = event;
  }
...
export class Battle__battlesResult {
  ...
  constructor(value0: BigInt, value1: string, value2: i32, value3: Address) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
    this.value3 = value3;
...
export class Battle extends ethereum.SmartContract {
  ...
  battles(param0: BigInt): Battle__battlesResult {
    let result = super.call(
      "battles",
      "battles(uint256):(uint256,string,uint8,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  calculateAttackDamage(attack: BigInt): BigInt {
    let result = super.call(
      "calculateAttackDamage",
      "calculateAttackDamage(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(attack)]
    );

    return result[0].toBigInt();
  }

  try_calculateAttackDamage(attack: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "calculateAttackDamage",
      "calculateAttackDamage(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(attack)]
  ...
  getBattle(_battleId: BigInt): Battle__getBattleResultValue0Struct {
    let result = super.call(
      "getBattle",
      "getBattle(uint256):((uint256,string,address[2],uint256[2],uint256[2],uint256[2],uint8,address,uint256[2],uint256[2],bool[2]))",
...
export class CalculateAttackDamageCall extends ethereum.Call {
  get inputs(): CalculateAttackDamageCall__Inputs {
    return new CalculateAttackDamageCall__Inputs(this);
  }

  get outputs(): CalculateAttackDamageCall__Outputs {
    return new CalculateAttackDamageCall__Outputs(this);
  }
}

export class CalculateAttackDamageCall__Inputs {
  _call: CalculateAttackDamageCall;

  constructor(call: CalculateAttackDamageCall) {
    this._call = call;
  }
...
export class CalculateAttackDamageCall__Outputs {
  _call: CalculateAttackDamageCall;
